...
import { setPage, setPerPage, setSearch } from "../../../../slice/userTableSlice";
...
export default function UserDataTable() {
  ...
  const { page, per_page, search } = useSelector((state: RootState) => state.userTable);
  ...
  const meta = users?.meta || { total: 0, total_pages: 0 };
