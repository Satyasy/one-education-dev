...
import { CreatePanjarItemRequest } from "../../../types/panjarItem";
import { unitOptions } from "../utils/panjarHelpers";
import Select from "../../../components/form/Select";

interface AddPanjarItemModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: CreatePanjarItemRequest) => void;
  isLoading: boolean;
}

export default function AddPanjarItemModal({ 
  isOpen, 
  onClose, 
  onSubmit, 
  isLoading 
}: AddPanjarItemModalProps) {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-end w-full gap-3 mt-6">
          ...
          <Button 
            ...
            type="submit"
            disabled={isLoading}
            startIcon={isLoading ? undefined : <Plus className="w-4 h-4" />}
          >
